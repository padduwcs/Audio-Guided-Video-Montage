...
* Nhận `clip_metadata.json`, `embedding_metadata.json` và embedding/index.
* Trả về top-k clip phù hợp cho từng audio segment.
...
2. `docs/analysis.md` — phân tích ý tưởng; triển khai theo Data Contract và `docs/samples/`.
...
8. `docs/details/11_team_assignment.md`
   Xem phân công module, input/output bàn giao và trách nhiệm phối hợp.

9. `docs/details/12_integration_plan.md`
   Xem kế hoạch tích hợp, thứ tự validate và quy tắc debug pipeline.
